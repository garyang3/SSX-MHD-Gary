...
# of cores used.
#mesh = None
mesh = [24,72] #gonna need 24*24 cores
...
solver.stop_wall_time = 60*60*30 #60*60*6 this means 6 hours
...
slice2d_writes = solver.evaluator.add_file_handler('2dslices', max_writes=500, sim_dt=output_cadence, mode='overwrite')
...
slice1d_writes = solver.evaluator.add_file_handler('1dslices', max_writes=500, sim_dt=output_cadence, mode='overwrite')
#integrate over xy
...
field_at_pos_writes = solver.evaluator.add_file_handler('bfield', max_writes=500, sim_dt=output_cadence, mode='overwrite')
