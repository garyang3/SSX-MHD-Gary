...
eta_sp = params.getfloat('eta_sp')
eta_ch = params.getfloat('eat_ch')
v0_ch = params.get('v0_ch')
...
##########################################################################################################################################
            ...
            elif((r >= 1 - lambda_rho_r and r <= 1 + lambda_rho_r)):
...
field_writes = solver.evaluator.add_file_handler('fields_two', max_writes = field_max_writes, sim_dt = output_cadence, mode = 'overwrite')
...
parameter_max_writes = file_handling.getfloat('parameter_max_writes')
parameter_writes = solver.evaluator.add_file_handler('parameters_two', max_writes = parameter_max_writes, sim_dt = output_cadence, mode = 'overwrite')
...
load_max_writes = file_handling.getfloat('load_max_writes')
load_writes = solver.evaluator.add_file_handler('load_data_two', max_writes = load_max_writes, sim_dt = output_cadence, mode = 'overwrite')
